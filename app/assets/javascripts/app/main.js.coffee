...
@jobListing = angular.module('JobListing', ['ngResource', 'ui.compat', 'ck-editor', 'csrf', 'utf8', 'salary-range', 'skillUserSearch', 'locationSearch', 'ngSanitize', 'attributeArrayLimit'])
