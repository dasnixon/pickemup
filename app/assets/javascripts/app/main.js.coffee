...
@jobListing = angular.module('JobListing', ['ngResource', 'ui.compat', 'ck-editor', 'csrf', 'utf8', 'igTruncate', 'salary-range', 'skillUserSearch', 'locationSearch', 'ui-collapse', 'ngSanitize'])
@techStack = angular.module('TechStack', ['ngResource', 'ui.compat', 'csrf', 'utf8'])
@userEdit = angular.module('Users', ['ngResource', 'ui.compat', 'ck-editor', 'csrf', 'utf8', 'igTruncate', 'salary-between', 'languageCompanySearch', 'locationSearch', 'ui-collapse', 'ngSanitize'])
