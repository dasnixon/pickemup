pickemup.controller("PreferencesController", ['$scope', '$location', '$state', '$stateParams', 'Preference', ($scope, $location, $state, $stateParams, Preference) ->
  ...
  if $state.current.name == 'user_preferences'
