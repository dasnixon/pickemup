...
jobListing.controller("JobListingCtrl", ['$scope', '$http', '$state', '$stateParams', 'JobListing', function($scope, $http, $state, $stateParams, JobListing) {
  $scope.jobListing     = {}
  $scope.errors         = []
  $scope.success        = ''
  ...
  preference_app.controller("PreferencesController", function($scope, $http, $location, $state, $stateParams, Preference) {
    ...
    if ($state.current.name === 'edit') {
      Preference.getPreference({
        ...
        return $scope.preference = response;
      }, function(response) {
    ...
    $scope.updateSkills = function(skill) {
      if ($scope.preference.skills[skill]) {
        return $scope.skills_changed[skill] = false;
      } else {
        return $scope.skills_changed[skill] = true;
      }
    };
    return $scope.update = function() {
      return Preference.update({
        ...
        $scope.error_updating = '';
        return $scope.preference.expected_salary = addCommas($scope.preference.expected_salary);
      }, function(response) {
