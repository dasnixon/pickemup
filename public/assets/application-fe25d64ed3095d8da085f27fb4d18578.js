...
(function() {
  this.app = angular.module('Pickemup', ['ngResource', 'ui.compat']);
...
(function() {
  app.controller("PreferencesController", function($scope, $http, $location, $state, $stateParams, Preference) {
    $scope.preference = {};
...
(function() {
  app.factory('Preference', function($resource) {
...
var jobListing = angular.module('jobListing', ['ngResource']);

jobListing.controller("JobListingCtrl", ['$scope', function($scope) {
  $scope.showData = function() {
    return $scope.data.jobListing;
  };
}]);

//function JobListingCtrl($scope) {
//  $scope.data = {jobTitle: "Something Else"};
//}
;
