...
var jobListing = angular.module('jobListing', []);

jobListing.controller("JobListingCtrl", ['$scope', '$state', function($scope) {
  debugger;
  $scope.greeting2 = "Hi there";
}]);
(function() {
...
(function() {
  ...
  jobListing.config(function($stateProvider, $urlRouterProvider, $locationProvider) {
    $locationProvider.html5Mode(true);
    $stateProvider.state("edit", {
      url: "/companies/:company_id/job_listings/:id/edit",
      views: {
        "": {
